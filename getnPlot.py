...
parser.add_argument('--bsfilt', action='store_true', help='Bandstop filter 4-15Hz.')
choices=['no','yes','3c']
...
parser.add_argument('--taper', action='store_true', help='10 percent cosine taper at each end of data' );
...
#    'MV.MBWH..SHZ',
    'MV.MRYT..SHZ',
    'MV.MSS1..SHZ',
    'MV.MBAM.10.HHE', 'MV.MBAM.10.HHN', 'MV.MBAM.10.HHZ',
...
if plotKind[0:5] == "close":
    ...
    stas = ["MBAM","MBCH", "MBGB", "MBHA", "MBJB", "MBMO", "MBSS", "MBWR"]
elif plotKind == "tfr":
...
if filePlot == "":
    ...
    if dataBSfilt:
        filePlot = filenameSeparator2.join([filePlot, 'bs'])
    if dataIntegrate:
...
if not runQuiet:
    ...
    print(' BS filter:          ' + str(dataBSfilt))
